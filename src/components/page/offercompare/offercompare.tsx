        ...
        <div className={`bg-shade min-vh-100`} >
                ...
                <Col sm={23} md={20} lg={18} xxl={18} className="px-5 my-2">
                    <Form form={form} layout="vertical">
                        ...
                        title={
                            ...
                            <p className="text-primary2 fs-5 fw-bolder">
                                RFQ number : <span className="fw-light p-2 border rounded-pill">{id}</span>
                            </p>
                        ...
                        >
                            ...
                            <Row gutter={[16, 16]}>
                                ...
                                <Col span={24}>
                                    <Form.Item
                                        label={<span style={{ fontWeight: "bold", fontSize: "1.3rem" }}>Sort By</span>}
                                        layout="vertical"
                                    >
                                        <Row gutter={[16, 16]}>
                                            {sortOptions.map((e: string) => (
                                                <Col sm={8} md={6} key={e}>
                                                    <Button
                                                        ...
                                                        block
                                                        shape="round"
                                                        style={{ textWrap: "wrap", lineHeight: 1 }}
                                                        type={sortBy === e ? "primary" : "default"}
                                                        onClick={() => {
                            ...
                            <Col span={24}>
                                ...
                                <Col span={24}>
                                    <div className="d-flex flex-column ">
                                        <span className='fw-bold fs-5'>Filter By</span>
                                    </div>
                                    ...
                                    <Col span={5}>
                                        <Form.Item
                                            rules={[{ required: true }]}
                                            label={`Transhipment Ports`}
                                        >
                                            <LocodeSelect
                                                change={(e: any) => { }}
                                                wholeValue={(e: any) => {
                                                    form.setFieldValue("transhipmentPorts", JSON.stringify(e.title));
                                                }}
                                            />
                                        </Form.Item>
                            ...
                            <Row justify="end" gutter={[16, 16]} className="mt-3">
                                <Col>
                                    <Button
                                        type="default"
            ...
            <Row gutter={[8, 8]} justify={"center"} className='p-5'>
                {(offers ? offers : []).map((i: any) => (
                    <Col sm={23} md={20} lg={18} xxl={18} key={i._id} style={{ marginBottom: '25px' }}>
            ...
            <Row gutter={[8, 8]} justify={"center"} className='p-5'>
                {(!isLoading && offers.length < 1) &&
                    <Col sm={23} md={20} lg={18} xxl={18} style={{ marginBottom: '25px' }} >
                        <Card>
