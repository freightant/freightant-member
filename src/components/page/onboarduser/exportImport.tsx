    ...
    return (
        ...
        >
            ...
            <Row gutter={[16, 8]} justify={"center"}>
                ...
                <Col xs={22} sm={22} md={12} lg={12}>
                    <Form.Item label="Mobile No [Point of Contact / EXIM / Logistics Team]" required name={["pointSalesPricingTeam", `mobile`]} rules={[{ required: true, message: "This field is required." }]}>
                        <Select mode={"tags"} showSearch={false} notFoundContent={<></>} suffixIcon={null} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={22} sm={22} md={12} lg={12}>
                    <Form.Item label="Escalation/Emergency Contact Numbers" name="emergencyContactNumber" rules={[{ required: true, message: "This field is required." }]}>
