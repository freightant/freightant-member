...
function OfferDetail({ params,previewData=false ,hideExtra=false }: { params: { id: string }, previewData?:any,hideExtra?:any }) {
  ...
  return (
    ...
    <Button className="rounded-6 p-4 px-3  bg-light border fs-5" onClick={()=>window.close()}>
    ← Back
        </Button>
    ...
    <Col xs="auto" className="d-flex justify-content-center">
        <div className="rounded-5 border p-1 px-5 primary-bg-color fs-5">
            {d?.data?.organization?.companyName}
        </div>
    </Col>


    <Col xs="auto" className="d-flex justify-content-end">
        <div className="rounded-5 p-1 px-3 bg-light border fs-5">
            Quote ID
        </div>
    </Col>
      </Row>
      ...
      <Row className='card-content rounded-3 p-4 my-2' gutter={[15, 15]}>
        <Col xs={24} md={9}>
          <div className="d-flex flex-column gap-2">
            <span className='fw-semibold fs-5 text-primary2'>Port of Loading</span>
      ...
      <Row gutter={[10, 10]}>
            ...
            <Col xs={24}>
                <div className="card-content rounded-3 p-4">
                    ...
                    <div className="d-flex gap-4 my-3">
                      {d?.data?.rfq?.modeOfShipment===strings.air?
                    ...
                    <div className="shippment-port-container">
                        <h4 className='m-3 fw-semibold'>Transshipment Ports</h4>
                        <Row>
                            ...
                            <Space>
                                <Timeline
                                    ...
                                    rootClassName=''
                                    items={[
                                        ...[{ label:<strong>Port of Loading</strong>, children: <PortUI {...{style:{minWidth:"300px",maxWidth:"370px"}}} i={d?.data?.rfq?.loadingPortObj} /> }],
                                        ...(d?.data?.transShipmentPorts ? d?.data?.transShipmentPorts : []).map((port: any, iIndex: number) => (
                                            { label: <strong>T/S Port {iIndex + 1}</strong>, children: (<PortUI {...{style:{minWidth:"300px",maxWidth:"370px"}}} i={port} />) }
                                        )),
                                        ...[{ label: <strong>Port of Discharge</strong>, children: <PortUI {...{style:{minWidth:"300px",maxWidth:"370px"}}} i={d?.data?.rfq?.dischargePortObj} /> },]
                                    ]}
                                />
                            </Space>
                            </Col>
            ...
            <Row gutter={[0, 10]}>
              <Col xs={24}>
                <div className="card-content left-card rounded-2 p-3 d-flex flex-column align-items-center gap-2">
                  <h5 className='fw-bold'>Exchange Rate</h5>
                  <span>USD/INR</span>
              ...
              <Col xs={24} className='me-auto'>
                <div className="card-content left-card rounded-2 p-3 d-flex flex-column align-items-center gap-2">
                  <h5 className='fw-bold'>SI Cut off Date & Time</h5>
                  <div className="tag-content">
              ...
              <Col xs={24} className='me-auto'>
                <div className="card-content left-card rounded-2 p-3 d-flex flex-column align-items-center gap-2">
                  <h5 className='fw-bold'>Port Cut off Date & Time</h5>
                  <div className="tag-content">
              ...
              <Col xs={24} className='me-auto'>
                <div className="card-content left-card rounded-2 p-3 d-flex flex-column align-items-center gap-2">
                  <h5 className='fw-bold'>POL Free Time</h5>
                  <div className="tag-content">
              ...
              <Col xs={24} className='me-auto'>
                <div className="card-content left-card rounded-2 p-3 d-flex flex-column align-items-center gap-2">
                  <h5 className='fw-bold'>POD Free Time</h5>
                  <div className="tag-content">
                ...
                <Col xs={24} className=''>
                    <div className="flex-column h-100 d-flex justify-content-end">
                        <div className="card-content left-card rounded-2 p-3 d-flex flex-column align-items-center gap-2">
                            <h5 className='fw-bold'>Quotation validity Date</h5>
                            <div className="tag-content">
        ...
        <Col xs={24}>
          <div className="card-content rounded-3 p-4 my-2 d-flex gap-3 align-items-center">
            <span className='fw-bold fs-5'>Payment Terms</span>
        ...
        <Col xs={24}>
          <div className="card-content rounded-3 p-4 my-2">
            <span className='fw-bold fs-5'>Terms and Conditions</span><br/>
      ...
      <Row className='my-3' justify={'center'}>
        <Col xs={24} md={8}>
          <div className={hideExtra?"d-none":""}>
            <Button block type="primary" shape="round" className='rounded-5 submit-form-btn'>Confirm Order</Button>
          </div>
        </Col>
      </Row>
      </div>}
